...
> ⚠️ **Note:** Frame extraction and OpenPose execution are assumed as pre-processing steps and are **not included in this repository**.

1. **Frame Extraction (External)**  
   Video frames should be extracted at a fixed interval (e.g., 1 frame per second).

2. **Skeleton Extraction (External)**  
